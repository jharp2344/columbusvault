...
const BUILDERS = [
  {
    ...
    badge: 'Columbus HQ',
    yearsInColumbus: 50,
    activeCommunities: 19,
    priceRange: '$340K – $1.2M',
    targetMatch: '$420K – $1.2M',
    stars: 4.5,
    knownFor: 'Columbus-headquartered for 50+ years. Broadest floorplan range in the metro and the largest active community count. Strong design center with energy-efficient standard features. Builds in Powell, Westerville, Sunbury, Plain City, Grove City, Reynoldsburg, Hilliard, Commercial Point, Dublin, Pataskala, Lewis Center, Galena, Marysville, and Delaware.',
    typicalIncentives: ['Permanent rate buydowns to high-5%s', 'Up to $15K closing cost credit', 'Bonus design center dollars on QMIs'],
    site: 'mihomes.com',
    flagshipCommunities: ['Evans Farm (Lewis Center)', 'New Albany Country Club Communities', 'Big Walnut Reserve (Sunbury)', 'Highpointe (Powell)'],
    communities: [
      { name: 'Big Walnut Reserve', area: 'Sunbury', miles: 22, range: '$450K – $625K', district: 'Big Walnut Local', status: 'Active' },
      { name: 'Evans Farm', area: 'Lewis Center', miles: 18, range: '$525K – $750K', district: 'Olentangy Local', status: 'Active' },
      { name: 'Highpointe', area: 'Powell', miles: 16, range: '$500K – $700K', district: 'Olentangy Local', status: 'Active' },
      { name: 'New Albany Country Club Communities', area: 'New Albany', miles: 14, range: '$600K – $900K', district: 'New Albany-Plain Local', status: 'Active' },
      { name: 'Mill Creek', area: 'Marysville', miles: 33, range: '$445K – $595K', district: 'Marysville Exempted Village', status: 'Active' },
    ],
  },
  {
    id: 'pulte-homes',
    ...
    targetMatch: '$420K – $850K',
    stars: 4.2,
    knownFor: 'Heavy emphasis on personalization. Interactive design tools and broad selection menu. Pulte Mortgage in-house lender frequently bundles incentives. Builds across Blacklick, Delaware, Dublin, Galena, Galloway, Hilliard, Lewis Center, Lockbourne, Marysville, New Albany, Plain City, Powell, South Bloomfield, Sunbury, and Westerville.',
    typicalIncentives: ['Aggressive QMI flex cash (~$20K)', 'Permanent rate buydown via Pulte Mortgage', 'Lot premium reductions'],
    site: 'pulte.com',
    flagshipCommunities: ['Liberty Grand (Powell)', 'Bridgewater (Powell)', 'Seven Pines (Sunbury)'],
    communities: [
      { name: 'Liberty Grand', area: 'Powell', miles: 17, range: '$475K – $625K', district: 'Olentangy Local', status: 'Active' },
      { name: 'Seven Pines', area: 'Sunbury', miles: 23, range: '$430K – $580K', district: 'Big Walnut Local', status: 'Active' },
      { name: 'Bridgewater', area: 'Powell', miles: 16, range: '$520K – $700K', district: 'Olentangy Local', status: 'Active' },
      { name: 'Scottish Corners', area: 'Marysville', miles: 33, range: '$425K – $575K', district: 'Marysville Exempted Village', status: 'Active' },
    ],
  },
  {
    id: 'fischer-homes',
    ...
    priceRange: '$360K – $800K',
    targetMatch: '$420K – $800K',
    stars: 4.3,
    knownFor: 'Cincinnati-based regional builder with strong Columbus presence in Delaware, Pickerington, Canal Winchester, and Grove City. Known for design quality and a streamlined customization process. Has run FHA-friendly low-rate promotions including 4.75% on QMIs.',
    typicalIncentives: ['FHA rates as low as 4.75% on QMIs', 'Up to $25K closing cost on select homes', 'Free finished basement promotions'],
    site: 'fischerhomes.com',
    flagshipCommunities: ['Estates at Tartan Fields (Dublin)', 'Gardens at Glenross (Delaware)'],
    communities: [
      { name: 'Gardens at Glenross', area: 'Delaware', miles: 24, range: '$435K – $625K', district: 'Olentangy Local', status: 'Active' },
      { name: 'Estates at Tartan Fields', area: 'Dublin', miles: 15, range: '$575K – $800K', district: 'Dublin City', status: 'Active' },
      { name: 'Hidden Bay', area: 'Pickerington', miles: 14, range: '$420K – $560K', district: 'Pickerington Local', status: 'Active' },
      { name: 'Newark Landing', area: 'Newark', miles: 38, range: '$395K – $535K', district: 'Newark City', status: 'Active' },
    ],
  },
  {
    id: 'rockford-homes',
  ...
  },
  {
    ...
    stars: 3.8,
    knownFor: "America's largest homebuilder by volume. Focused on entry-level and first-move-up. Most affordable new construction in the metro. Express line offers fastest QMI closings.",
    typicalIncentives: ['FHA rates near 3.99% on select QMIs (often time-limited)', 'Up to $10K closing cost', 'Refrigerator/blinds packages'],
    site: 'drhorton.com',
    flagshipCommunities: ['Lakefield Place (Canal Winchester)', 'Pickerington Pointe', 'Riverbend (Grove City)'],
    communities: [
      { name: 'Lakefield Place', area: 'Canal Winchester', miles: 16, range: '$385K – $475K', district: 'Canal Winchester Local', status: 'Active' },
      { name: 'Pickerington Pointe', area: 'Pickerington', miles: 14, range: '$405K – $510K', district: 'Pickerington Local', status: 'Active' },
      { name: 'Riverbend', area: 'Grove City', miles: 11, range: '$395K – $525K', district: 'South-Western City', status: 'Active' },
      { name: 'The Overlook', area: 'Newark', miles: 38, range: '$375K – $475K', district: 'Newark City', status: 'Active' },
    ],
  },
  {
    id: 'three-pillar',
  ...
  },
  {
    ...
    yearsInColumbus: 14,
    activeCommunities: 9,
    priceRange: '$465K – $1.1M',
    targetMatch: '$465K – $1.1M',
    stars: 4.5,
    knownFor: 'Family-owned premium builder out of Kentucky. Strong custom-feel design within production framework. Olentangy and Dublin school district concentration.',
    typicalIncentives: ['Design center bonus dollars', 'Permanent rate buydown options', 'Closing cost programs'],
    site: 'dreeshomes.com',
    flagshipCommunities: ['Tartan West (Dublin)', 'Highland Lakes (Westerville)'],
    communities: [
      { name: 'Tartan West', area: 'Dublin', miles: 15, range: '$625K – $850K', district: 'Dublin City', status: 'Active' },
      { name: 'Highland Lakes', area: 'Westerville', miles: 13, range: '$525K – $725K', district: 'Olentangy Local', status: 'Active' },
    ],
  },
  {
    id: 'epcon',
  ...
  return (
    ...
    >
      ...
      <div className="text-xs uppercase tracking-widest mb-5" style={{ color: 'rgba(255,255,255,0.4)', letterSpacing: '0.15em' }}>
        {builder.yearsInColumbus} yrs in Columbus · {builder.activeCommunities} active communities
      </div>
      ...
      <div className="flex items-center justify-between">
        <div className="text-sm flex items-center gap-1.5" style={{ color: 'rgba(255,255,255,0.7)' }}>
          ...
          <span>{builder.communities.length} communities in radius</span>
        </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-8 pb-8 border-b" style={{ borderColor: 'rgba(255,255,255,0.08)' }}>
            ...
            <div>
              ...
              <dl className="space-y-2 text-sm">
                ...
                <div className="flex justify-between"><dt style={{ color: 'rgba(255,255,255,0.5)' }}>Active communities</dt><dd>{builder.activeCommunities}</dd></div>
